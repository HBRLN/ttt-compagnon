  ...
  return (
    <div className="flex min-h-dvh flex-col pb-10">
      <header className="flex items-center gap-2 px-4 pt-6 pb-2">
        ...
        <h1 className="massif text-3xl">Confidentialité</h1>
      </header>
      ...
      <div className="flex flex-col gap-4 px-5 pt-2 text-encre-douce">
        ...
        <section>
          <h2 className="font-medium text-encre">Ce qui est collecté</h2>
          <p>
        ...
        <section>
          <h2 className="font-medium text-encre">Pourquoi</h2>
          <p>
        ...
        <section>
          <h2 className="font-medium text-encre">Combien de temps</h2>
          <p>
        ...
        <section>
          <h2 className="font-medium text-encre">Comment demander la suppression</h2>
          <p>
